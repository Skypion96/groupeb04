...
public class Main {
	...
	public static void main(String[] args) {
		...
		Question q16 = new Question("Maxime", Round.FIRST_ROUND, "In the Mendeleev's table, which acronym stands for gold?");
		q15.addChoice("Go", false);
		q15.addChoice("Au", true);
		q15.addChoice("Gd", false);
		q15.addChoice("Or", false);
		Question q17 = new Question("Maxime", Round.SECOND_ROUND, "Which beach name was a real name during the Normandy landing?");
